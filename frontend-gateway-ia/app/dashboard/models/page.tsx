...
import { RawModelsView } from "@/components/models/raw-models-view";
...
export default function ModelsPage() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "analysis" | "table" | "raw">("overview");
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs Navigation */}
      <div className="flex space-x-1 rounded-lg bg-muted p-1 w-max">
        <button
        ...
        <button
          ...
          className={`px-4 py-2 text-sm font-medium rounded-md transition-all ${activeTab === "analysis"
            ? "bg-background shadow text-foreground"
            : "text-muted-foreground hover:bg-background/50 hover:text-foreground"
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 text-sm font-medium rounded-md transition-all ${activeTab === "table"
            ? "bg-background shadow text-foreground"
            : "text-muted-foreground hover:bg-background/50 hover:text-foreground"
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 text-sm font-medium rounded-md transition-all ${activeTab === "raw"
            ? "bg-background shadow text-foreground"
            : "text-muted-foreground hover:bg-background/50 hover:text-foreground"
            }`}
        >
      ...
      {activeTab === "analysis" && allModels && (
        <div className="animate-in fade-in-50 duration-500">
          <ModelCharts models={allModels} />
        </div>
      )}

      {activeTab === "table" && allModels && (
        <div className="animate-in fade-in-50 duration-500">
          <ModelsTable models={filteredModels.length > 0 ? filteredModels : allModels} />
        </div>
      )}

      {activeTab === "raw" && allModels && (
        <div className="animate-in fade-in-50 duration-500">
          <RawModelsView models={allModels} />
        </div>
      )}
    </div>
  );
