...
│  │  • Registry Scraper (actualización de modelos)       │ │
│  │  • Cron Job (ejecuta scraping diario)                │ │
│  └────────────────────────────────────────────────────────┘ │
│                         │                                    │
└─────────────────────────┼────────────────────────────────────┘
                          │
...
│  • models.json (catálogo actualizado por scrapers)          │
│  • registry_changelog (historial de cambios)                │
└─────────────────────────────────────────────────────────────┘
```
...
┌──────────────────────────────────────────────────────────┐
│ FASE 4: REGISTRY UPDATE SYSTEM (2-3 días)                │
├──────────────────────────────────────────────────────────┤
│ ✓ Scrapers por proveedor (OpenAI/Anthropic/Google)      │
│ ✓ Endpoint de actualización manual del registry         │
│ ✓ Lógica de comparación y backup seguro                 │
│ ✓ Cron job dentro del contenedor backend                │
│ ✓ Sistema de detección y notificación de cambios        │
│                                                          │
│ Entregable: Registry actualizándose automáticamente     │
│ Test: models.json se actualiza diariamente vía scraping │
└──────────────────────────────────────────────────────────┘
