...
## 🔄 Fase 4: Updater Service (Checkpoints 41-45)

### ✅ Checkpoint 41: Updater Container Setup
- Crear Dockerfile para updater service
- Configurar como servicio en docker-compose.yml
- Implementar script Python básico
- **Entregable**: Contenedor updater corriendo

### ✅ Checkpoint 42: GitHub Fetcher
- Implementar fetch de registry.json desde GitHub
- Crear validación de estructura JSON
- Implementar manejo de errores de red
- **Entregable**: Updater descargando registry de GitHub

### ✅ Checkpoint 43: Registry Update Logic
- Implementar comparación de versiones
- Crear backup de registry actual antes de actualizar
- Escribir nuevo models.json solo si hay cambios
- **Entregable**: Lógica de actualización segura

### ✅ Checkpoint 44: Scheduling
- Implementar schedule con APScheduler
- Configurar ejecución cada 24 horas
- Agregar trigger manual vía signal o endpoint
- **Entregable**: Updates automáticos programados

### ✅ Checkpoint 45: Notificaciones de Cambios
- Detectar cambios de precio en modelos
- Detectar nuevos modelos agregados
- Detectar modelos deprecados
- Enviar notificaciones (log, email opcional)
- **Entregable**: Sistema de alertas de cambios
...
Fase 4: Updater           [▱▱▱▱▱] 0/5   checkpoints
